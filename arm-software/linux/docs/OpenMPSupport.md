...
See the [status page](https://github.com/llvm/llvm-project/blob/release/22.x/clang/docs/OpenMPSupport.rst)
for the details on Clang OpenMP support.

## Flang OpenMP support

See the [status page](https://github.com/llvm/llvm-project/blob/release/22.x/flang/docs/OpenMPSupport.md)
