...
def main():
    ...
    xfails = [
        ...
        XFail(
            name="dummy fenv implementation without hardware floating point",
            testnames=[
                "src/fenv/libc.test.src.fenv.enabled_exceptions_test.__build__",
                "src/fenv/libc.test.src.fenv.exception_flags_test.__build__",
                "src/fenv/libc.test.src.fenv.exception_status_test.__build__",
                "src/fenv/libc.test.src.fenv.feupdateenv_test.__build__",
                "src/fenv/libc.test.src.fenv.getenv_and_setenv_test.__build__",
                "src/fenv/libc.test.src.fenv.rounding_mode_test.__build__",
            ],
            result=NewResult.XFAILED,
            project="llvmlibc",
            variants=[
            ...
            description="LLVM libc uses dummy fenv operations when __ARM_FP is unavailable.",
        ),
        XFail(
