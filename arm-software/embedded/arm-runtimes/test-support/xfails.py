    ...
    xfails = [
        ...
        XFail(
            ...
            testnames=[
                ...
                "std/depr/depr.c.headers/signal_h.compile.pass.cpp",
                "std/depr/depr.c.headers/stdint_h.pass.cpp",
                "std/language.support/cstdint/cstdint.syn/cstdint.pass.cpp",
                "std/language.support/support.runtime/csignal.pass.cpp",
            ],
            result=NewResult.XFAILED,
            project="libcxx",
            variants=[
            ...
            description="LLVM libc does not provide the signal.h required by these tests.",
        ),
        XFail(
            name="llvmlibc missing uchar conversion support",
            testnames=[
                "std/depr/depr.c.headers/uchar_h.compile.pass.cpp",
                "std/strings/c.strings/cuchar.compile.pass.cpp",
            ],
            ...
            conditional=check_llvmlibc,
            description="LLVM libc does not provide uchar.h conversion functions such as mbrtoc16, c16rtomb, mbrtoc32, and c32rtomb.",
        ),
        XFail(
            name="llvmlibc unsupported math.h/cmath header scope",
            testnames=[
            ...
            conditional=check_llvmlibc,
            description="LLVM libc does not provide the full math.h/cmath declaration scope expected by these header tests.",
        ),
        XFail(
            ...
            testnames=[
                ...
                "std/depr/depr.c.headers/stdio_h.compile.pass.cpp",
        ...
        XFail(
            name="llvmlibc missing math functions",
            testnames=[
                "libcxx/fuzzing/random.pass.cpp",
                "libcxx/numerics/c.math/constexpr-cxx23-clang.pass.cpp",
                "std/numerics/c.math/hermite.pass.cpp",
                "std/numerics/complex.number/cmplx.over/pow.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/acos.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/acosh.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/asin.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/asinh.pass.cpp",
                ...
                "std/numerics/complex.number/complex.transcendentals/cos.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/cosh.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/exp.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/log.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/log10.pass.cpp",
                ...
                "std/numerics/complex.number/complex.transcendentals/sin.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/sinh.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/sqrt.pass.cpp",
                "std/numerics/complex.number/complex.transcendentals/tan.pass.cpp",
                ...
                "std/numerics/complex.number/complex.value.ops/polar.pass.cpp",
                "std/numerics/numarray/valarray.nonmembers/valarray.transcend/cosh_valarray.pass.cpp",
                "std/numerics/numarray/valarray.nonmembers/valarray.transcend/sinh_valarray.pass.cpp",
                "std/numerics/numarray/valarray.nonmembers/valarray.transcend/tanh_valarray.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/assign.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/copy.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/ctor_int_double.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/ctor_param.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/eq.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/get_param.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/io.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/max.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/min.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/param_assign.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/param_copy.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/param_ctor.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/param_eq.pass.cpp",
                "std/numerics/rand/rand.dist/rand.dist.bern/rand.dist.bern.bin/set_param.pass.cpp",
            ],
            result=NewResult.XFAILED,
            project="libcxx",
            variants=[
            ...
            conditional=check_llvmlibc,
            description="LLVM libc is missing math/libm functions resulting in link errors.",
        ),
        XFail(
