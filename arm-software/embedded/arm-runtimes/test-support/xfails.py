...
def main():
    ...
    xfails = [
        ...
        XFail(
            name="LLVM-libc fenv tests without hardware floating point",
            testnames=[
            ...
            description="LLVM-libc fenv operations are not supported without hardware floating point.",
        ),
        XFail(
            name="LLVM-libc sprintf long double tests",
            testnames=[
                "src/stdio/libc.test.src.stdio.sprintf_test.__build__",
            ],
            result=NewResult.XFAILED,
            project="llvmlibc",
            variants=[
            ...
            description="The test expects an extended-precision long double implementation.",
        ),
        XFail(
