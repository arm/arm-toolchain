...
def main():
    ...
    xfails = [
        ...
        XFail(
            name="cbrt 1-ULP Error Non-Nearest",
            testnames=[
            ...
            description="cbrt misses exact cube roots by 1 ULP under non-nearest rounding modes (LLVMAENG-6232)",
        ),
        XFail(
            name="exp10 1-ULP error non-nearest",
            testnames=[
            ...
            description="llvm-libc exp10 returns 1-ULP neighbors under non-nearest rounding modes (LLVMAENG-6243)",
        ),
        XFail(
            name="log10 exact power assumption",
            testnames=[
            ...
            description="log10_test assumes exact log10 in LIBC_MATH_SKIP_ACCURATE_PASS hermetic builds (LLVMAENG-6248)",
        ),
        XFail(
            name="Double overflow ignores rounding",
            testnames=[
            ...
            description="dynamic FP rounding mode ignored for double overflow/underflow codegen (LLVMAENG-6242)",
        ),
        XFail(
            name="fmaf returns +0 downward",
            testnames=[
            ...
            description="fmaf float returns +0 for FE_DOWNWARD (LLVMAENG-6226)",
        ),
        XFail(
            name="logf downward returns -0",
            testnames=[
            ...
            description="logf returns -0.0 under FE_DOWNWARD (LLVMAENG-6252)",
        ),
    ]
