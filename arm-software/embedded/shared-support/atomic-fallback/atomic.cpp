...
#define DEFINE_ATOMIC_SIZE(N, TYPE)                                                                                  \
  ...
  WEAK TYPE __atomic_fetch_add_##N(TYPE *ptr, TYPE value, int) { return fallback_fetch_modify(ptr, value, Add{}); }  \
  WEAK TYPE __atomic_fetch_sub_##N(TYPE *ptr, TYPE value, int) { return fallback_fetch_modify(ptr, value, Sub{}); }  \
  WEAK TYPE __atomic_fetch_and_##N(TYPE *ptr, TYPE value, int) { return fallback_fetch_modify(ptr, value, And{}); }  \
  WEAK TYPE __atomic_fetch_or_##N(TYPE *ptr, TYPE value, int) { return fallback_fetch_modify(ptr, value, Or{}); }    \
  WEAK TYPE __atomic_fetch_xor_##N(TYPE *ptr, TYPE value, int) { return fallback_fetch_modify(ptr, value, Xor{}); }  \
  WEAK TYPE __atomic_fetch_nand_##N(TYPE *ptr, TYPE value, int) { return fallback_fetch_modify(ptr, value, Nand{}); }
...
WEAK bool __shared_support_atomic_is_lock_free(std::size_t, const volatile void *) noexcept { return false; }
