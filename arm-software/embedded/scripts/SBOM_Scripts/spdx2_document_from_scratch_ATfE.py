...
#
# Usage: python spdx2_document_from_scratch_ATfE.py
#
# Output file generated: sbom_atfe.spdx.json
#
import logging
import uuid
...
package_uuid_llvm = "SPDXRef-Package-" + str(
    uuid.uuid5(uuid.NAMESPACE_URL, "https://github.com/llvm/llvm-project")
)
...
write_file(document, "sbom_atfe.spdx.json")
