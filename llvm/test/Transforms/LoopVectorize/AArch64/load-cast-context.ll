...
; CHECK-NEXT:    [[N_MOD_VF10:%.*]] = urem i64 [[TMP0]], 8
; CHECK-NEXT:    [[N_VEC11:%.*]] = sub i64 [[TMP0]], [[N_MOD_VF10]]
; CHECK-NEXT:    [[TMP32:%.*]] = insertelement <8 x i32> zeroinitializer, i32 [[BC_MERGE_RDX]], i32 0
; CHECK-NEXT:    br label %[[VEC_EPILOG_VECTOR_BODY:.*]]
; CHECK:       [[VEC_EPILOG_VECTOR_BODY]]:
; CHECK-NEXT:    [[INDEX12:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL]], %[[VEC_EPILOG_PH]] ], [ [[INDEX_NEXT15:%.*]], %[[VEC_EPILOG_VECTOR_BODY]] ]
; CHECK-NEXT:    [[VEC_PHI13:%.*]] = phi <8 x i32> [ [[TMP32]], %[[VEC_EPILOG_PH]] ], [ [[TMP39:%.*]], %[[VEC_EPILOG_VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[WIDE_LOAD14:%.*]] = load <8 x i8>, ptr [[TMP38]], align 1
; CHECK-NEXT:    [[TMP34:%.*]] = zext <8 x i8> [[WIDE_LOAD14]] to <8 x i32>
; CHECK-NEXT:    [[TMP39]] = or <8 x i32> [[VEC_PHI13]], [[TMP34]]
...
; CHECK-NEXT:    [[TMP40:%.*]] = call i32 @llvm.vector.reduce.or.v8i32(<8 x i32> [[TMP39]])
